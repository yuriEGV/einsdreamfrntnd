            ...
            <div style={{
                ...
                <div>
                    ...
                    <p style={{ color: 'var(--text-secondary)', fontSize: '0.9rem', margin: 0, maxWidth: '550px' }}>
                        Descarga la aplicación móvil EinsDream v2.9.2 para Android, colócala junto a tu cama y activa el monitoreo inteligente al acostarte.
                    </p>
                </div>
                ...
                <div style={{ display: 'flex', gap: '0.75rem', flexWrap: 'wrap' }}>
                    ...
                    >
                        <Download size={18} />
                        <span>Descargar APK v2.9.2</span>
                    </a>
                    <button
