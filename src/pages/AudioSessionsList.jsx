                    ...
                    <div style={{
                        ...
                        <div className="glass-card" style={{ padding: '1.5rem' }}>
                            ...
                            <div style={{ fontSize: '0.75rem', color: '#38BDF8', marginTop: '0.35rem', fontWeight: '600' }}>
                                📱 Sincronizadas desde app v2.9.0
                            </div>
                        </div>
                        ...
                        {loadingNights ? (
                            ...
                            <div style={{ padding: '4rem 2rem', textAlign: 'center' }}>
                                ...
                                <p style={{ color: 'var(--text-secondary)', fontSize: '0.85rem', maxWidth: '500px', margin: '0 auto 1.5rem' }}>
                                    Para ver estadísticas reales aquí, inicia una grabación en la app móvil Einsdream v2.9.0, finalízala por la mañana y pulsa <strong>"Sincronizar con sistema web"</strong> en la pestaña <strong>Score</strong>.
                                </p>
                            </div>
                        ) : (
